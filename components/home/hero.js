...
export default function Hero() {
  return (
    <section className="section-spacing split-hero split-hero-home">
      <div className="container">
        <div className="split-hero-grid">
          <div className="split-hero-copy">
            <span className="split-hero-kicker">Technology Consulting</span>
              ...
              <div className="card h-100 text-center border-0 shadow-sm hover-card">
                <div className="card-body">
                  ...
                  <p className="text-muted small mb-0">
                    Custom software solutions, application development, and system integration
                  </p>
                </div>
              </div>
            </Link>
            ...
            <Link href="/services" className="text-decoration-none">
              <div className="card h-100 text-center border-0 shadow-sm hover-card">
                <div className="card-body">
                  ...
                  <p className="text-muted small mb-0">
                    Data entry, processing, secure storage, and governance strategies
                  </p>
                </div>
              </div>
            </Link>
              ...
              <div className="card h-100 text-center border-0 shadow-sm hover-card">
                <div className="card-body">
                  <div className="mb-3">
                    ...
                    >
                      <i
                        className="fas fa-shield-alt eyn-primary"
                  ...
                  <p className="text-muted small mb-0">
                    Risk assessment, network security, compliance support, and vulnerability
                    management
                  </p>
                </div>
              </div>
            ...
            <Link href="/services" className="text-decoration-none">
              <div className="card h-100 text-center border-0 shadow-sm hover-card">
                <div className="card-body">
                  ...
                  <p className="text-muted small mb-0">
                    Cloud computing services including migration, deployment, and optimization
                  </p>
                </div>
              </div>
            </Link>
            ...
            <Link href="/services" className="text-decoration-none">
              <div className="card h-100 text-center border-0 shadow-sm hover-card">
                <div className="card-body">
                  ...
                  <p className="text-muted small mb-0">
                    Technology strategy, digital transformation, and ongoing IT support
                    services
                  </p>
                </div>
              </div>
